...
from dataload.data import num_classes, num_input_channels, image_size, num_pixels
from resnet import resnet8
# from vgg import vgg11_nodropout -> no vgg for now...

_CONV_OPTIONS = {"kernel_size": 3, "padding": 1, "stride": 1, "padding_mode": "zeros"}
...
def load_architecture(arch_id: str, dataset_name: str) -> nn.Module:
    ...
    # ======= vary depth =======
        ...
        raise ValueError(f"arch_id is {arch_id}")